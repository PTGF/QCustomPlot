...
#ifndef PLUGINS_BARCHARTVIEW_BARCHARTVIEWPLUGIN_H
#define PLUGINS_BARCHARTVIEW_BARCHARTVIEWPLUGIN_H
        ...
        public Core::ViewManager::IViewFactory
{
    ...
    Q_PLUGIN_METADATA(IID "org.krellinst.ptgf.BarChartViewPlugin")
#endif
...
public:
    BarChartViewPlugin(QObject *parent = 0);
...
#endif // PLUGINS_BARCHARTVIEW_BARCHARTVIEWPLUGIN_H
